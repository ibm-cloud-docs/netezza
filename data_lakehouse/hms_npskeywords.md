...
If there are schema names in Hive Metastore that are NPS keywords, you cannot use those keywords as identifiers when using the schema either in **SET SCHEMA name** <name> or cross schema reference in **SELECT col from** <schema_name>.<tablename> queries.
